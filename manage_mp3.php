                    ...
                    <div class="col-lg-3 col-sm-6 col-xs-12">
                        <div class="block_wallpaper">
                            <div class="wall_category_block">
                                <h2>
                                    <?php 
                                    if(strlen($row['mp3_duration']) > 18){
                                        echo mb_substr(stripslashes($row['mp3_duration']), 0, 17).'...';  
                                    }else{
                            ...
                            <div class="wall_image_title">
                                ...
                                <p>
                                    <?php 
                                    if(strlen($row['mp3_artist']) > 30){
                                        echo mb_substr(stripslashes($row['mp3_artist']), 0, 29).'...';  
                                    }else{
                                        echo $row['mp3_artist'];
                                    }
                                    ?>
                                ...
                                <ul>
                                    <li><a href="edit_mp3.php?mp3_id=<?php echo $row['id'];?>" target="_blank" data-toggle="tooltip" data-tooltip="Edit"><i class="fa fa-edit"></i></a></li><li>
                                    <a href="" class="btn_delete_a" data-id="<?php echo $row['id'];?>"  data-toggle="tooltip" data-tooltip="Delete"><i class="fa fa-trash"></i></a></li>
                                </ul>
                            </div>
